...
import com.example.msap_prv_del.Notification.ServiceNotification;
...
public class MyService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        SharedPreferences prefs= getSharedPreferences("com.example.msap_prv_del.ActiveServiceRunning", MODE_PRIVATE);
    ...
    public void onDestroy() {
        ...
        Intent broadcastIntent = new Intent("com.example.msap_prv_del");
